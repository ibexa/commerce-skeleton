...
var PreviewBlock = /*#__PURE__*/function (_Component) {
  ...
  _createClass(PreviewBlock, [{
    ...
    value: function render() {
      ...
      }), this.renderActionMenu(), this.renderConfigPopup());
    }
  }]);
...
var LayoutSelector = /*#__PURE__*/function (_Component) {
  ...
  _createClass(LayoutSelector, [{
    ...
    value: function renderLayoutItem(data) {
      var itemAttrs = {
        key: data.id,
        className: 'c-layout-selector__item',
        onClick: this.markItemAsSelected
      };

      if (data.id === this.state.itemSelectedId) {
        itemAttrs.className = "".concat(itemAttrs.className, " ").concat(itemAttrs.className, "--selected");
      }
    ...
    key: "renderSaveDraftWarning",
    value: function renderSaveDraftWarning() {
      if (!this.props.displaySaveDraftWarning) {
        return null;
      }
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "c-layout-selector__header-subtitle"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_icon_icon__WEBPACK_IMPORTED_MODULE_3__["default"], {
    ...
    value: function render() {
      ...
      }, this.props.title), this.renderSaveDraftWarning(), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
        type: "button",
  ...
  _createClass(PageBuilder, [{
    ...
    value: function validateBlockData(block, config) {
      return block.attributes.every(function (attribute) {
        ...
        if (attrConfig && attrConfig.constraints && attrConfig.constraints.not_blank) {
    ...
    value: function insertBlockDataIntoZone(zones, newBlock, zoneId, nextBlockId) {
      var updatedZones = zones.map(function (zone) {
        ...
        if (isSameZone && nextBlockId) {
          ...
          zone.blocks.splice(zone.blocks.indexOf(nextBlock), 0, newBlock);
    ...
    value: function renderSinglePreviewBlock(block) {
      ...
      var convertDateToTimezone = window.eZ.helpers.timezone.convertDateToTimezone;
      var isEditable = this.state.timestamp <= convertDateToTimezone(new Date()).valueOf();
    ...
    value: function renderSidebarBlocks() {
      ...
      var isDraggable = this.state.timestamp <= convertDateToTimezone(new Date()).valueOf() && iframeLoaded;
    ...
    value: function render() {
      ...
      }, this.modalContainer && this.renderLayoutSelector(), this.layoutSwitcherContainer && this.renderLayoutSwitcher(), this.timelineContainer && this.renderTimeline(), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
...
__webpack_require__(/*! /home/jenkins/workspace/DXP/Archive_Maker_Commerce/ibexa-commerce/vendor/ezsystems/ezplatform-page-builder/src/bundle/ui-dev/src/modules/page.builder.module.js */"./vendor/ezsystems/ezplatform-page-builder/src/bundle/ui-dev/src/modules/page.builder.module.js");
__webpack_require__(/*! /home/jenkins/workspace/DXP/Archive_Maker_Commerce/ibexa-commerce/vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/infobar.js */"./vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/infobar.js");
__webpack_require__(/*! /home/jenkins/workspace/DXP/Archive_Maker_Commerce/ibexa-commerce/vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/fieldType/ezlandingpage.js */"./vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/fieldType/ezlandingpage.js");
__webpack_require__(/*! /home/jenkins/workspace/DXP/Archive_Maker_Commerce/ibexa-commerce/vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/page.builder.publish.js */"./vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/page.builder.publish.js");
__webpack_require__(/*! /home/jenkins/workspace/DXP/Archive_Maker_Commerce/ibexa-commerce/vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/page.builder.right.sidebar.toggler.js */"./vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/page.builder.right.sidebar.toggler.js");
module.exports = __webpack_require__(/*! /home/jenkins/workspace/DXP/Archive_Maker_Commerce/ibexa-commerce/vendor/ezsystems/ezplatform-segmentation/src/bundle/ui-dev/src/modules/page.builder.update.preview.request.params.js */"./vendor/ezsystems/ezplatform-segmentation/src/bundle/ui-dev/src/modules/page.builder.update.preview.request.params.js");
