...
/***/ "./vendor/ezsystems/ezcommerce-page-builder/src/bundle/Resources/public/js/sku.slider.selector.js":
/*!********************************************************************************************************!*\
  !*** ./vendor/ezsystems/ezcommerce-page-builder/src/bundle/Resources/public/js/sku.slider.selector.js ***!
  \********************************************************************************************************/
...
(function (global, doc, eZ) {
  ...
  var skuSliderSelectors = doc.querySelectorAll('.ez-sku-slider-selector');
  var enterKeyCode = 13;

  var updateInputValue = function updateInputValue(itemsContainer) {
    var items = _toConsumableArray(itemsContainer.querySelectorAll('.ez-sku-slider-selector__selected-item'));
  ...
  var attachEventsToSelectedItem = function attachEventsToSelectedItem(itemsContainer, item) {
    return item.querySelector('.ez-btn--trash').addEventListener('click', removeItem.bind(_this, itemsContainer), false);
  };

  var addDraggableItem = function addDraggableItem(itemsContainer, draggable, item) {
    var fragment = doc.createDocumentFragment();
    var template = itemsContainer.dataset.template;
    var container = doc.createElement('div');
    var renderedItem = template.replace('{{ name }}', eZ.helpers.text.escapeHTML(item.name)).replace('{{ sku }}', eZ.helpers.text.escapeHTML(item.sku)).replace('{{ image }}', eZ.helpers.text.escapeHTML(item.image));
    container.insertAdjacentHTML('beforeend', renderedItem);
    var listItem = container.querySelector('.ez-sku-slider-selector__selected-item');
  ...
  var handleKeyDown = function handleKeyDown(skuSliderSelector, itemsContainer, draggable, event) {
  ...
  var search = function search(skuSliderSelector, itemsContainer, draggable) {
    var inputValue = skuSliderSelector.querySelector('.ez-sku-slider-selector__search-input').value;
    var request = new Request(Routing.generate('siso_auto_suggest', {
      search_terms: inputValue
    }), {
      mode: 'same-origin',
    ...
    fetch(request).then(eZ.helpers.request.getJsonFromResponse).then(function (response) {
      ...
      skuSliderSelector.querySelector('.ez-sku-slider-selector__search-results').classList.remove('ez-sku-slider-selector__search-results--hidden');
    })["catch"](eZ.helpers.notification.showErrorNotification);
  };

  var addSearchResultsItems = function addSearchResultsItems(skuSliderSelector, itemsContainer, draggable, items) {
    var fragment = doc.createDocumentFragment();
    var searchResultsContainer = skuSliderSelector.querySelector('.ez-sku-slider-selector__search-results');
    var template = searchResultsContainer.dataset.template;

    var appendItem = function appendItem(item, notAddable) {
      var container = doc.createElement('div');
      var renderedItem = template.replace('{{ name }}', eZ.helpers.text.escapeHTML(item.value));
      container.insertAdjacentHTML('beforeend', renderedItem);
      var addButton = container.querySelector('.ez-btn--add');

      if (notAddable) {
        addButton.remove();
      } else {
        addButton.addEventListener('click', function () {
          addDraggableItem(itemsContainer, draggable, {
            name: item.value,
            sku: item.data.sku,
    ...
    if (items.length === 0) {
      var value = Translator.trans(
      /*@Desc("Could not find product.")*/
      'sku_slider_selector.cannot_find.error', {}, 'block_config_ui');
      appendItem({
        value: value
      }, true);
    }
  ...
  var skuSliderSelectorDraggable = /*#__PURE__*/function (_global$eZ$core$Dragg) {
    "use strict";

    _inherits(skuSliderSelectorDraggable, _global$eZ$core$Dragg);

    var _super = _createSuper(skuSliderSelectorDraggable);

    function skuSliderSelectorDraggable() {
      _classCallCheck(this, skuSliderSelectorDraggable);

      return _super.apply(this, arguments);
    }

    _createClass(skuSliderSelectorDraggable, [{
      key: "attachEventHandlersToItem",
      value: function attachEventHandlersToItem(item) {
        _get(_getPrototypeOf(skuSliderSelectorDraggable.prototype), "attachEventHandlersToItem", this).call(this, item);
      ...
      value: function onDrop() {
        _get(_getPrototypeOf(skuSliderSelectorDraggable.prototype), "onDrop", this).call(this);

        updateInputValue(this.itemsContainer);
      }
    }]);

    return skuSliderSelectorDraggable;
  }(global.eZ.core.Draggable);

  skuSliderSelectors.forEach(function (skuSliderSelector) {
    var itemsContainer = skuSliderSelector.querySelector('.ez-sku-slider-selector__selected-items');
    var searchButton = skuSliderSelector.querySelector('.ez-btn--search');
    var searchInput = skuSliderSelector.querySelector('.ez-sku-slider-selector__search-input');
    var draggable = new skuSliderSelectorDraggable({
    ...
    var inputValue = skuSliderSelector.closest('.ez-data-source').querySelector('.ez-data-source__input').value;
    var selectedItems = inputValue ? JSON.parse(inputValue) : [];
    searchButton.addEventListener('click', search.bind(_this, skuSliderSelector, itemsContainer, draggable), false);
    searchInput.addEventListener('keydown', handleKeyDown.bind(_this, skuSliderSelector, itemsContainer, draggable), false);
    draggable.init();
    selectedItems.forEach(addDraggableItem.bind(_this, itemsContainer, draggable));
  });
...
/***/ "./vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/block.config.content.height.js":
/*!****************************************************************************************************************************!*\
  !*** ./vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/block.config.content.height.js ***!
  \****************************************************************************************************************************/
/*! no static exports found */
...
(function (global, doc) {
  global.addEventListener('load', function () {
    var configElement = doc.querySelector('.ez-block-config');
    var tabsElement = configElement.querySelector('.ez-block-config__tabs');
    var contentElement = configElement.querySelector('.ez-block-config__content');
    var actionsElement = configElement.querySelector('.ez-block-config__actions');
...
/***/ 99:
/*!***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** multi ./vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/block.config.content.height.js ./vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/base/block.config.embed.field.base.js ./vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/base/block.config.select.field.base.js ./vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/base/block.config.schedule.field.base.js ./vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/base/block.config.scheduler.js ./vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/base/block.config.fields.errors.js ./vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/widgets/embed.js ./vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/widgets/video.js ./vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/widgets/select.js ./vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/widgets/checkbox.js ./vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/widgets/collection.js ./vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/widgets/schedule.js ./vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/widgets/richtext.js ./vendor/ezsystems/ezplatform-segmentation/src/bundle/Resources/public/js/widgets/targeted.content.map.js ./vendor/ezsystems/ezcommerce-page-builder/src/bundle/Resources/public/js/sku.slider.selector.js ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /home/jenkins/workspace/DXP/Archive_Maker_Commerce/ibexa-commerce/vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/block.config.content.height.js */"./vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/block.config.content.height.js");
__webpack_require__(/*! /home/jenkins/workspace/DXP/Archive_Maker_Commerce/ibexa-commerce/vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/base/block.config.embed.field.base.js */"./vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/base/block.config.embed.field.base.js");
__webpack_require__(/*! /home/jenkins/workspace/DXP/Archive_Maker_Commerce/ibexa-commerce/vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/base/block.config.select.field.base.js */"./vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/base/block.config.select.field.base.js");
__webpack_require__(/*! /home/jenkins/workspace/DXP/Archive_Maker_Commerce/ibexa-commerce/vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/base/block.config.schedule.field.base.js */"./vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/base/block.config.schedule.field.base.js");
__webpack_require__(/*! /home/jenkins/workspace/DXP/Archive_Maker_Commerce/ibexa-commerce/vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/base/block.config.scheduler.js */"./vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/base/block.config.scheduler.js");
__webpack_require__(/*! /home/jenkins/workspace/DXP/Archive_Maker_Commerce/ibexa-commerce/vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/base/block.config.fields.errors.js */"./vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/base/block.config.fields.errors.js");
__webpack_require__(/*! /home/jenkins/workspace/DXP/Archive_Maker_Commerce/ibexa-commerce/vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/widgets/embed.js */"./vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/widgets/embed.js");
__webpack_require__(/*! /home/jenkins/workspace/DXP/Archive_Maker_Commerce/ibexa-commerce/vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/widgets/video.js */"./vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/widgets/video.js");
__webpack_require__(/*! /home/jenkins/workspace/DXP/Archive_Maker_Commerce/ibexa-commerce/vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/widgets/select.js */"./vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/widgets/select.js");
__webpack_require__(/*! /home/jenkins/workspace/DXP/Archive_Maker_Commerce/ibexa-commerce/vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/widgets/checkbox.js */"./vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/widgets/checkbox.js");
__webpack_require__(/*! /home/jenkins/workspace/DXP/Archive_Maker_Commerce/ibexa-commerce/vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/widgets/collection.js */"./vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/widgets/collection.js");
__webpack_require__(/*! /home/jenkins/workspace/DXP/Archive_Maker_Commerce/ibexa-commerce/vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/widgets/schedule.js */"./vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/widgets/schedule.js");
__webpack_require__(/*! /home/jenkins/workspace/DXP/Archive_Maker_Commerce/ibexa-commerce/vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/widgets/richtext.js */"./vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/config-form/widgets/richtext.js");
__webpack_require__(/*! /home/jenkins/workspace/DXP/Archive_Maker_Commerce/ibexa-commerce/vendor/ezsystems/ezplatform-segmentation/src/bundle/Resources/public/js/widgets/targeted.content.map.js */"./vendor/ezsystems/ezplatform-segmentation/src/bundle/Resources/public/js/widgets/targeted.content.map.js");
module.exports = __webpack_require__(/*! /home/jenkins/workspace/DXP/Archive_Maker_Commerce/ibexa-commerce/vendor/ezsystems/ezcommerce-page-builder/src/bundle/Resources/public/js/sku.slider.selector.js */"./vendor/ezsystems/ezcommerce-page-builder/src/bundle/Resources/public/js/sku.slider.selector.js");
