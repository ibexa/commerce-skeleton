...
(function (doc, React, ReactDOM, eZ) {
  ...
  var layoutValidator = new eZ.EzLandingPageLayoutValidator({
    classInvalid: 'is-invalid',
    pageBuilder: pageBuilder,
    fieldSelector: SELECTOR_FIELD,
    eventsMap: [{
  ...
  eZ.fieldTypeValidators = eZ.fieldTypeValidators ? [].concat(_toConsumableArray(eZ.fieldTypeValidators), [validator, layoutValidator]) : [validator, layoutValidator];
...
module.exports = __webpack_require__(/*! /home/jenkins/workspace/DXP/Archive_Maker_Commerce/ibexa-commerce/vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/page.builder.edit.js */"./vendor/ezsystems/ezplatform-page-builder/src/bundle/Resources/public/js/page.builder.edit.js");
