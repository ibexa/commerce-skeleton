...
return [
    ...
    Ibexa\Bundle\CompatibilityLayer\IbexaCompatibilityLayerBundle::class => ['all' => true],
    ...
    Ibexa\Bundle\PersonalizationClient\IbexaPersonalizationClientBundle::class => ['all' => true],
