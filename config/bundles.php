...
return [
    ...
    Siso\Bundle\TestToolsBundle\SisoTestToolsBundle::class => ['all' => true],
    Siso\Bundle\VoucherBundle\SisoVoucherBundle::class => ['all' => true],
    ...
    Siso\RestApiBundle\SisoRestApiBundle::class => ['all' => true],
